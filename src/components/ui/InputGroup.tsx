...
import type { Todo } from '../Todo/TodoItem';
      ...
      >
        <div className='flex items-center gap-4 pr-3'>
          ...
          <Button disabled={!isValid || isPending} type='submit' variant="fill" rounded="normal">
            {isValid && !isPending ? (
              <svg className="popup-animate w-4 h-8" fill='currentColor' viewBox="0 0 448 512">
                <path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"></path>
              </svg>
            ) : isPending ? (
              <svg className="animate-spin w-4 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
