...
const TodoListView = () => {
  const todos = [
    ...
    },
    {
      ...
      description:
        'Update all npm packages to their latest stable versions and test for breaking changes',
      done: false,
      dueDate: '2026-01-20',
    },
    {
    ...
    },
    {
      ...
      description:
        'Identify and optimize slow queries affecting application performance',
      done: false,
      dueDate: '2026-01-25',
    },
  ];
